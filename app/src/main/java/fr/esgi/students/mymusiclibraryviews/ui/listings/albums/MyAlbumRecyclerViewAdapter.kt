...
import fr.esgi.students.mymusiclibraryviews.databinding.FragmentArtistAlbumBinding
...
class MyAlbumRecyclerViewAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(
            FragmentArtistAlbumBinding.inflate(
    ...
    inner class ViewHolder(binding: FragmentArtistAlbumBinding) : RecyclerView.ViewHolder(binding.root) {
